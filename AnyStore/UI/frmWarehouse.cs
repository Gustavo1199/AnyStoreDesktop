...
namespace AnyStore.UI
{
    public partial class frmWarehouse : Form
    {
        ...
        warehouseBLL c = new warehouseBLL();
        ...
        private void btnADD_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Inserte el título.");
                return;
            }
        ...
        private void dgvWarehouse_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {

            //Finding the Row Index of the Row Clicked on Data Grid View
            int RowIndex = e.RowIndex;
            txtCategoryID.Text = dgvWarehouse.Rows[RowIndex].Cells[0].Value.ToString();
            txtTitle.Text = dgvWarehouse.Rows[RowIndex].Cells[1].Value.ToString();
            txtDescription.Text = dgvWarehouse.Rows[RowIndex].Cells[2].Value.ToString();
        }
    }
}
