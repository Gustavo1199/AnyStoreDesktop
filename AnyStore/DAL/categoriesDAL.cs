    ...
    class categoriesDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                string sql = "SELECT id as Código, title as Título, description as Descripción, added_date as 'Fecha Creación', (select username from tbl_users b where a.added_by = b.id) as 'Usuario Ultima Actualización' FROM tbl_categories a";
        ...
        public bool Insert(categoriesBLL c)
        {
            ...
            try
            {
                ...
                string sqle = "SELECT * FROM tbl_categories where title ='" + c.title+"'";
                ...
                adapter.Fill(dt);
                if (dt.Rows.Count > 0)
                    throw new Exception("Título ya existente");
