    ...
    class userDAL
    {
        ...
        public DataTable Select()
        {
            ...
            try
            {
                ...
                String sql = "SELECT id as Código, first_name as Nombres, last_name as Apellidos, email as Correo, username as Usuario, password as Contraseña, contact as Teléfono, address as Dirección, gender as Sexo, user_type as Rol, added_date as 'Fecha Creación', (select username from tbl_users b where a.added_by = b.id) as 'Usuario Ultima Actualización'  FROM tbl_users a";
        ...
        public bool Insert(userBLL u)
        {
            ...
            try
            {
                ...
                DataTable dt = new DataTable();
                string sqle = "SELECT * FROM tbl_users where username ='" + u.username + "'";
